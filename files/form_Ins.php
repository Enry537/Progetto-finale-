...
<form action="?insert=success" method="POST">
  ...
  <br>
    ...
    <input type="image" src="files/img/button_ins.jpg" alt="completa inserimento" onMouseOver="this.src='files/img/button_insh.jpg';" onMouseOut="this.src='files/img/button_ins.jpg';" border="0"/><br>
  </p>
