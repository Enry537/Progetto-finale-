...
<form action="?registration=success" method="POST">
  ...
  <p><br>
    ...
    <input type="image" src="files/img/button_reg.jpg" alt="completa registrazione" onMouseOver="this.src='files/img/button_regh.jpg';" onMouseOut="this.src='files/img/button_reg.jpg';" border="0"/><br>
  </p>
